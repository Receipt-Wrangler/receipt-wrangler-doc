...
* Edit pencil: Users can click this button to edit the data on the selected row. This button is only displayed if your
  group role allows editing the group.
* Delete button: Users can click this button to delete the group on the selected row. This action will delete all
  receipts
  associated with the group. This button is only displayed if your group role allows deleting the group.
